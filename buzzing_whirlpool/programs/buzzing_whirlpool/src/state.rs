...
pub struct LiquidityPool {
    ...
    pub tick_spacing: u16,      // tick 间距，决定价格精度
    pub sqrt_price: u128,        // 当前价格的平方根，使用 Q64.64 定点数格式
    pub tick_current_index: i32, // 当前价格对应的 tick 索引
    pub current_price: u64,      // 当前价格，使用 6 位小数
    pub liquidity: u128,         // 当前流动性，用于计算价格变化和滑点
    pub fee_rate: u32,           // 交易费率 (例如 3000 对应 0.3% for FEE_RATE_MUL_VALUE=1,000,000)
    pub active: bool,
}
