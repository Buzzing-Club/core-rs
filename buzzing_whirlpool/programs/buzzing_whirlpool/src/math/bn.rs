...
impl U256 {
    pub fn try_into_u64(self) -> Result<u64, PredictionMarketError> {
        self.try_into().map_err(|_| PredictionMarketError::NumberCastError)
    }

    pub fn try_into_u128(self) -> Result<u128, PredictionMarketError> {
        self.try_into().map_err(|_| PredictionMarketError::NumberCastError)
    }
